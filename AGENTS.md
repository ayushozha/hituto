...
This file provides guidance to AI coding agents working in this repository. It assumes you
know nothing about the project. `CLAUDE.md` is a near-mirror of this file — keep the two in
